...
pub const ParserMsg = union(enum) {
    ...
    pub fn getHelp(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_before_for_body, .expect_identifier_for_binding, .expect_in => writer.writeAll(
            ...
            .missing_brace_after_label => writer.writeAll("syntax to to declare a labelled lock is ':<label> {}'"),
