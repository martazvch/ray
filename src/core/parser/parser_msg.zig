...
pub const ParserMsg = union(enum) {
    ...
    pub fn getMsg(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_only_fn_in_trait => writer.writeAll("expect only function declaration in traits"),
    ...
    pub fn getHint(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_fn_end_container, .expect_only_fn_in_trait => writer.writeAll("this is unexpected"),
