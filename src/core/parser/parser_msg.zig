...
pub const ParserMsg = union(enum) {
    ...
    pub fn getHint(self: Self, writer: *Writer) !void {
        try switch (self) {
            .cant_chain_op, .trait_impl_trait => writer.writeAll("this one is not allowed"),
            ...
            .enum_lit_non_ident => writer.writeAll("this is not an identifier"),
            ...
            .invalid_label => writer.writeAll("this label is invalid"),
