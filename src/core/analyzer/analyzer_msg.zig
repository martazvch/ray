...
pub const AnalyzerMsg = union(enum) {
    ...
    pub fn getHint(self: Self, writer: *Writer) !void {
        try switch (self) {
            .union_constr_expect_one_arg, .union_constr_named_arg, .union_constr_useless_paren => writer.writeAll(""),
            .already_declared,
            ...
            .enum_discr_duplicate, .enum_discr_not_int, .enum_discr_not_comptime => writer.writeAll("this discriminant"),
            .error_not_in_union => writer.writeAll("this is not part of declaration"),
            .error_with_return, .err_union_err_lhs => writer.writeAll("this is an error"),
            .err_union_non_err_rhs => writer.writeAll("this is not an error"),
            ...
            .match_useless => writer.writeAll("this arm could be inlined"),
            .match_useless_alias => writer.writeAll("this aliases an identifier"),
            .match_partial_overlap, .match_unreachable_arm => writer.writeAll("this arm"),
            .match_regular_on_union => writer.writeAll("this is a union"),
            ...
            .missing_fn_in_trait, .missing_fn_impl_in_trait => writer.writeAll("this function"),
            ...
            .not_a_trait => writer.writeAll("this type"),
            ...
            .trait_default_value => writer.writeAll("this is not allowed"),
